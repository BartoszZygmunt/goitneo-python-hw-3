...
class Record:
    ...
    def __str__(self):
        if self.birthday:
            return f"name: {self.name.value}, phones: {'; '.join(str(p) for p in self.phones)}, Birthday: {self.birthday.value}"
        else:
            return f"name: {self.name.value}, phones: {'; '.join(str(p) for p in self.phones)}, Birthday: I don't know"
    ...
    while True:
        ...
        if command == "add":
            try:
                ...
                print(f"Contact {name} added, phone number {phone}")
            ...
            try:
                ...
                print(e)
                print("Invalid command. Use 'remove-phone [name] [phone]'")
            ...
            try:
                ...
                if record:
                    ...
                    print(f"Phone number changed.")
                else:
                    print(f"Contact not found")
            except ValueError as e:
                print(e)
                print("Invalid command. Use 'change [name] [new phone]'")
